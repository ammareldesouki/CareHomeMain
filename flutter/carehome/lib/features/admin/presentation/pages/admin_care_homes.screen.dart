...
class AdminCareHomesScreen extends StatefulWidget {
  const AdminCareHomesScreen({super.key});

  @override
  State<AdminCareHomesScreen> createState() => _AdminCareHomesScreenState();
}

class _AdminCareHomesScreenState extends State<AdminCareHomesScreen>
        ...
        if (list.isEmpty && !isLoadingMore) {
          return _EmptyView(
            ...
            message: _searchQuery.isNotEmpty
                ...
                : 'No ${_tabs[_tabController.index].label.toLowerCase()} verifications',
          );
        }
