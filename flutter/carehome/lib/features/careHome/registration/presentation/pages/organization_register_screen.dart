...
import 'package:carehome/features/careHome/registration/wedgits/individual_form.dart';
import 'package:carehome/features/careHome/registration/wedgits/multiple_form.dart';
        ...
        builder: (_) => RegistrationContractScreen(
          ...
          onSigned: () {
            if (selectedType == EmployerType.individual) {
              _registrationBloc.add(SubmitRegistrationEvent());
              Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(
                  builder: (_) => PswPreferenceScreen(bloc: _registrationBloc),
                ),
                (route) => false,
              );
            } else {
